...
public static class Extensions {
    ...
    public delegate bool TransformAction(Transform t);

    public static void IterateParents(this Transform t, TransformAction action) {
        if (t == null) return;
        if (action(t)) return;
        IterateParents(t.parent,action);
    }
    public static void RecurseTransform(this Transform t,TransformAction action)
    {
        action(t);
    ...
    public static void RecurseChildren(this Transform t, TransformAction action) {
        foreach (Transform childTransform in t) {
            action(childTransform);
            RecurseChildren(childTransform,action);
        }
    }
}